...
public:
    ...
    typedef std::function<void (int32_t _status)> updateOilReply_t;
    typedef std::function<void (int32_t _status)> updateHandleReply_t;
    ...
    /// This is the method that will be called on remote calls on the method updateOil.
    virtual void updateOil(const std::shared_ptr<CommonAPI::ClientId> _client, int32_t _oil, updateOilReply_t _reply) = 0;
    /// This is the method that will be called on remote calls on the method updateHandle.
    virtual void updateHandle(const std::shared_ptr<CommonAPI::ClientId> _client, int32_t _handle, updateHandleReply_t _reply) = 0;
