...
public:
    ...
    typedef std::function<void(const CommonAPI::CallStatus&, const int32_t&)> UpdateOilAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const int32_t&)> UpdateHandleAsyncCallback;
    ...
    virtual void updateOil(int32_t _oil, CommonAPI::CallStatus &_internalCallStatus, int32_t &_status, const CommonAPI::CallInfo *_info = nullptr) = 0;
    virtual std::future<CommonAPI::CallStatus> updateOilAsync(const int32_t &_oil, UpdateOilAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr) = 0;
    virtual void updateHandle(int32_t _handle, CommonAPI::CallStatus &_internalCallStatus, int32_t &_status, const CommonAPI::CallInfo *_info = nullptr) = 0;
    virtual std::future<CommonAPI::CallStatus> updateHandleAsync(const int32_t &_handle, UpdateHandleAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr) = 0;
