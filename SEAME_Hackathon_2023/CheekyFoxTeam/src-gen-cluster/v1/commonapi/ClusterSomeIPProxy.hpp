 ...
 */
#ifndef V1_COMMONAPI_CLUSTER_SOMEIP_PROXY_HPP_
#define V1_COMMONAPI_CLUSTER_SOMEIP_PROXY_HPP_
...
public:
    ...
    virtual void updateOil(int32_t _oil, CommonAPI::CallStatus &_internalCallStatus, int32_t &_status, const CommonAPI::CallInfo *_info);

    virtual std::future<CommonAPI::CallStatus> updateOilAsync(const int32_t &_oil, UpdateOilAsyncCallback _callback, const CommonAPI::CallInfo *_info);

    virtual void updateHandle(int32_t _handle, CommonAPI::CallStatus &_internalCallStatus, int32_t &_status, const CommonAPI::CallInfo *_info);

    virtual std::future<CommonAPI::CallStatus> updateHandleAsync(const int32_t &_handle, UpdateHandleAsyncCallback _callback, const CommonAPI::CallInfo *_info);
...
#endif // V1_COMMONAPI_Cluster_SOMEIP_PROXY_HPP_
