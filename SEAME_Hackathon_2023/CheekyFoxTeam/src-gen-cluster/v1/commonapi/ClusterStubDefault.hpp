...
public:
    ...
    COMMONAPI_EXPORT virtual void updateOil(const std::shared_ptr<CommonAPI::ClientId> _client, int32_t _oil, updateOilReply_t _reply) {
        (void)_client;
        (void)_oil;
        int32_t status = 0;
        _reply(status);
    }
    COMMONAPI_EXPORT virtual void updateHandle(const std::shared_ptr<CommonAPI::ClientId> _client, int32_t _handle, updateHandleReply_t _reply) {
        (void)_client;
        (void)_handle;
        int32_t status = 0;
        _reply(status);
