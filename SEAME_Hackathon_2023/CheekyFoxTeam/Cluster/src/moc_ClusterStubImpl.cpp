...
QT_MOC_LITERAL(4, 39, 9), // "signalOil"
QT_MOC_LITERAL(5, 49, 13), // "signalButtons"
QT_MOC_LITERAL(6, 63, 11), // "std::string"
QT_MOC_LITERAL(7, 75, 12) // "signalHandle"

    },
    "ClusterStubImpl\0signalSpeed\0\0signalRPM\0"
    "signalOil\0signalButtons\0std::string\0"
    "signalHandle"
};
...
void ClusterStubImpl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ClusterStubImpl *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalSpeed((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->signalRPM((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->signalOil((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->signalButtons((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        case 4: _t->signalHandle((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ClusterStubImpl::*)(int );
        ...
        {
            using _t = void (ClusterStubImpl::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClusterStubImpl::signalOil)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (ClusterStubImpl::*)(std::string );
        ...
        {
            using _t = void (ClusterStubImpl::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClusterStubImpl::signalHandle)) {
                *result = 4;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ClusterStubImpl::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_ClusterStubImpl.data,
    qt_meta_data_ClusterStubImpl,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 2
void ClusterStubImpl::signalOil(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 4
void ClusterStubImpl::signalHandle(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
